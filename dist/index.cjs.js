...
var StyledIconButton = styled__default['default'](IconButton)(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  &:hover {\n    background: transparent !important;\n  }\n"], ["\n  &:hover {\n    background: transparent !important;\n  }\n"])));
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { alignItems: "center", mt: isMobile ? "0" : "auto", mr: "45px" },
        !isMobile ? null : (React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: showSideBar },
            React__default['default'].createElement(Icon$z, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "ShibaNova home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "ShibaNova home page" }, innerLogo))));
};
var templateObject_1$a;
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement("a", { href: "https://github.com/ShibaNova/Contracts/tree/main/Audits", target: "_blank", rel: "noreferrer noopener" },
            React__default['default'].createElement(Icon$8, { style: { paddingRight: "5px", width: "40px" } })),
...
var SideBar = function (_a) {
    ...
    return (React__default['default'].createElement(StyledNav$1, { open: open },
        React__default['default'].createElement(StyledCloseButton, null,
            React__default['default'].createElement(Icon$_, { onClick: onDismiss })),
...
var Menu = function (_a) {
    ...
    var renderPrice = function () {
        return novaPriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
            React__default['default'].createElement(Icon$P, { width: "24px", mr: "5px" }),
