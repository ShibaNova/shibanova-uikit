...
var templateObject_1$M, templateObject_2$h, templateObject_3$8;
...
var Button = function (_a) {
    ...
    return (React__default['default'].createElement(StyledButton$1, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled }),
...
var Alert = function (_a) {
    ...
    return (React__default['default'].createElement(StyledAlert, { variant: variant },
...
var templateObject_1$H, templateObject_2$g, templateObject_3$7, templateObject_4$5;
...
var StyledButton = styled__default['default'](Button)(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background: ", ";\n  }\n"], ["\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.button.primary.backgroundActive;
});
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React__default['default'].createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "tertiary", colorKey: variant === variants$1.PRIMARY ? "text" : "text" }, props)));
    }
    // @ts-ignore: Unreachable code error
    return React__default['default'].createElement(StyledButton, __assign({ as: as, size: size, variant: variant }, props));
};
...
}, styledSystem.space, getGradientBorder);
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/coins/snova.png" })));
};
...
var templateObject_1$i, templateObject_2$8, templateObject_3$5, templateObject_4$4, templateObject_5$1;
...
var light$6 = (_a$1 = {},
    ...
    _a$1);
var dark$6 = (_b = {},
    _b[PRIMARY] = __assign(__assign({}, light$6.primary), { background: "linear-gradient(90deg, " + darkColors.secondary + " 0%, " + darkColors.primaryBright + " 100%)" }),
    _b[SECONDARY] = __assign(__assign({}, light$6.secondary), { color: darkColors.primary }),
    _b[TERTIARY] = __assign(__assign({}, light$6.tertiary), { background: darkColors.tertiary, backgroundActive: darkColors.tertiary, backgroundHover: darkColors.primaryDark, color: darkColors.background }),
...
var StyledIconButton = styled__default['default'](IconButton)(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  &:hover {\n    background: transparent !important;\n  }\n"], ["\n  &:hover {\n    background: transparent !important;\n  }\n"])));
var StyledModal = styled__default['default'].div(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  background: ", ";\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  border: 1px solid ", ";\n  border-radius: 32px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"], ["\n  background: ", ";\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  border: 1px solid ", ";\n  border-radius: 32px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var ModalHeader = styled__default['default'].div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid #e9eaeb;\n  align-items: center;\n  padding: 12px 24px;\n"], ["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid #e9eaeb;\n  align-items: center;\n  padding: 12px 24px;\n"])));
var ModalTitle = styled__default['default'](Flex)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  align-items: center;\n  flex: 1;\n"], ["\n  align-items: center;\n  flex: 1;\n"])));
var Modal = function (_a) {
    ...
    return (React__default['default'].createElement(StyledModal, __assign({}, props),
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(StyledIconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$1e, { color: "primary" }))),
                React__default['default'].createElement(Heading, null, title)),
            !hideCloseButton && (React__default['default'].createElement(StyledIconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
...
var templateObject_1$f, templateObject_2$5, templateObject_3$3, templateObject_4$3;
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 165" }, props),
        React__default['default'].createElement("image", { width: "205", href: isDark ? "/images/egg/LogoTextNewDark.png" : "/images/egg/LogoTextNewWhite.png" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, { alignItems: "center", mt: isMobile ? "0" : "auto", mr: "45px" },
        !isMobile ? null : (React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: showSideBar },
            React__default['default'].createElement(Icon$A, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "NovaDex home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "NovaDex home page" }, innerLogo))));
};
var templateObject_1$b;
...
var ButtonLabel = styled__default['default'](Button)(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  font-size: 15px;\n"], ["\n  font-size: 15px;\n"])));
var LinkLabel = styled__default['default'].div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  color: inherit;\n  transition: color 0.4s;\n  flex-grow: 1;\n  // font-weight: bold;\n  text-shadow: ", ";\n\n  &:hover {\n    opacity: 0.8;\n  }\n"], ["\n  color: inherit;\n  transition: color 0.4s;\n  flex-grow: 1;\n  // font-weight: bold;\n  text-shadow: ", ";\n\n  &:hover {\n    opacity: 0.8;\n  }\n"])), function (_a) {
    var glowing = _a.glowing, theme = _a.theme;
    return (glowing ? theme.shadows.text : "none");
});
...
, function (_a) {
    ...
    var secondary = _a.secondary, theme = _a.theme, isMobile = _a.isMobile;
    return secondary && !isMobile ? theme.colors.primaryBright : "transparent";
}, function (_a) {
    var theme = _a.theme;
...
var templateObject_1$a, templateObject_2$4, templateObject_3$2, templateObject_4$2;
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        ...
        React__default['default'].createElement(AccordionContent, { onClick: handleClick, isOpen: isOpen, maxHeight: React__default['default'].Children.count(children) * MENU_ENTRY_HEIGHT }, children)));
};
...
var NavBar = function (_a) {
    ...
    if (isMobile)
        return null;
    return (React__default['default'].createElement(Flex, { style: { maxWidth: "50%" } },
        React__default['default'].createElement(Container$1, null, links.map(function (entry) {
            ...
            if (entry.items) {
                return (React__default['default'].createElement(Accordion, { key: entry.label, label: entry.label.toUpperCase(), initialOpenState: entry.initialOpenState, className: calloutClass }, entry.items.map(function (item) {
                    return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname },
                        ...
                        React__default['default'].createElement(MenuLink, __assign({ href: item.href }, (item.external ? getExternalLinkProps() : {})), item.label)));
                })));
            }
            return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
                entry.icon && React__default['default'].createElement(MenuIcon, { icon: entry.icon }),
                React__default['default'].createElement(MenuLink, __assign({ href: entry.href }, (entry.external ? getExternalLinkProps() : {})), entry.button ? (React__default['default'].createElement(ButtonLabel, { size: "sm" }, entry.label.toUpperCase())) : (React__default['default'].createElement(LinkLabel, null, entry.label.toUpperCase())))));
        }))));
};
...
var Icon$1 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ "data-name": "Layer 1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 1000 1000" }, props),
        React__default['default'].createElement("defs", null,
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        React__default['default'].createElement(HelpLink, { href: "https://docs.novadex.finance/shibanova-documentation/how-to-connect-a-wallet", external: true },
...
var StyledNav$1 = styled__default['default'].nav(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  position: fixed;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  width: 85vw;\n  background: ", ";\n  display: block;\n  z-index: 100;\n  margin: 0;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  padding: 30px 20px 30px;\n  transform: ", ";\n  transition: transform 0.2s linear 0s;\n\n  overflow-y: auto;\n  overscroll-behavior-y: none;\n  -webkit-overflow-scrolling: touch;\n"], ["\n  position: fixed;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  width: 85vw;\n  background: ", ";\n  display: block;\n  z-index: 100;\n  margin: 0;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  padding: 30px 20px 30px;\n  transform: ", ";\n  transition: transform 0.2s linear 0s;\n\n  overflow-y: auto;\n  overscroll-behavior-y: none;\n  -webkit-overflow-scrolling: touch;\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledCloseButton = styled__default['default'].div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  position: absolute;\n  right: 20px;\n  top: 20px;\n  filter: drop-shadow(1px 1px 3px rgba(0, 170, 255, 0.584));\n"], ["\n  position: absolute;\n  right: 20px;\n  top: 20px;\n  filter: drop-shadow(1px 1px 3px rgba(0, 170, 255, 0.584));\n"])));
var StyledLinkList = styled__default['default'].div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  margin-top: 2vw;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n"], ["\n  margin-top: 2vw;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n"])));
var StyledLinkSeparator = styled__default['default'].hr(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  width: 200px;\n  border-color: ", ";\n"], ["\n  width: 200px;\n  border-color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
var SideBar = function (_a) {
    ...
    return (React__default['default'].createElement(StyledNav$1, { open: open },
...
var Menu = function (_a) {
    ...
    var renderPrice = function () {
        return novaPriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
            ...
            React__default['default'].createElement(Text, { fontSize: "15px", small: true, bold: true, marginRight: "10px" }, "$" + novaPriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
    };
    var renderPhxPrice = function () {
        return phxPriceUsd ? (React__default['default'].createElement(PriceLink, { href: phxPriceLink, target: "_blank" },
            React__default['default'].createElement(PhxIcon, { width: "24px", mr: "5px", marginLeft: "10px" }),
