...
var templateObject_1$L, templateObject_2$h, templateObject_3$8;
...
var StyledButton$1 = styled.button(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  align-items: center;\n  background: ", ";\n  border: ", ";\n  border-radius: 18px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: bold;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background 0.15s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background: ", ";\n    border-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  background: ", ";\n  border: ", ";\n  border-radius: 18px;\n  box-shadow: ", ";\n  color: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: bold;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background 0.15s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background: ", ";\n    border-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    background-color: ", ";\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"])), getButtonVariantProp("background"), getButtonVariantProp("border"), function (_a) {
    var glowing = _a.glowing, theme = _a.theme;
    return !glowing ? getButtonVariantProp("boxShadow") : "0px 0px 10px " + theme.colors.primary;
...
var Button = function (_a) {
    ...
    return (React.createElement(StyledButton$1, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled }),
...
var Icon$16 = function (props) {
    var theme = useTheme();
    var primaryColor = theme.isDark ? "#2f2f3c" : "#e9eaeb";
...
var templateObject_1$G, templateObject_2$g, templateObject_3$7, templateObject_4$5;
...
var StyledButton = styled(Button)(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background: ", ";\n  }\n"], ["\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var ButtonMenuItem = function (_a) {
    ...
    return React.createElement(StyledButton, __assign({ as: as, size: size, variant: variant }, props));
};
...
function (_a) {
    ...
    return outline ? "transparent" : variant === "primary" ? theme.button.primary.background : getColor(variant, theme);
}
/* eslint-enable */
, function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? "primary" : _b;
    return (variant === "primary" ? "0px" : "2px");
}, function (_a) {
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/coins/snova.png" })));
};
...
var templateObject_1$h, templateObject_2$8, templateObject_3$5, templateObject_4$4, templateObject_5$1;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#0000a4", textDisabled: "#BDC2C4", textSubtle: "#46e3f4", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#00aaff", background: "#0b23a2", backgroundDisabled: "#2f2f3c", backgroundAlt: "#27262c", contrast: "#FFFFFF", invertedContrast: "#191326", input: "transparent", primaryDark: "#0098A1", tertiary: "#040547", text: "#FFFFFF", textDisabled: "#4d547b", textSubtle: "#c4c7d4", borderColor: "#00aaff", card: "#061c7d", gradients: {
...
var light$6 = (_a$1 = {},
    ...
    _a$1);
var dark$6 = (_b = {},
    _b[PRIMARY] = __assign(__assign({}, light$6.primary), { background: "linear-gradient(90deg, " + darkColors.background + " 30%, " + darkColors.primary + " 100%)" }),
    _b[SECONDARY] = __assign({}, light$6.secondary),
    _b[TERTIARY] = __assign(__assign({}, light$6.tertiary), { background: darkColors.tertiary, backgroundActive: darkColors.tertiary, backgroundHover: darkColors.tertiary, color: darkColors.primary }),
    _b[TEXT] = __assign(__assign({}, light$6.text), { backgroundHover: darkColors.tertiary }),
...
var darkTheme = __assign(__assign({}, base), { isDark: true, alert: dark$7, button: dark$6, colors: darkColors, card: dark$5, toggle: dark$3, nav: dark$2, modal: dark$1, radio: dark$4, tooltip: dark });

var lightTheme = __assign(__assign({}, base), { isDark: false, alert: light$7, button: light$6, colors: lightColors, card: light$5, toggle: light$3, nav: light$2, modal: light$1, radio: light$4, tooltip: light });
...
var StyledIconButton = styled(IconButton)(templateObject_1$e || (templateObject_1$e = __makeTemplateObject(["\n  &:hover {\n    background: transparent !important;\n  }\n"], ["\n  &:hover {\n    background: transparent !important;\n  }\n"])));
var StyledModal = styled.div(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  background: ", ";\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  border: 1px solid ", ";\n  border-radius: 32px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"], ["\n  background: ", ";\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  border: 1px solid ", ";\n  border-radius: 32px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var ModalHeader = styled.div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid #e9eaeb;\n  align-items: center;\n  padding: 12px 24px;\n"], ["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid #e9eaeb;\n  align-items: center;\n  padding: 12px 24px;\n"])));
var ModalTitle = styled(Flex)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  align-items: center;\n  flex: 1;\n"], ["\n  align-items: center;\n  flex: 1;\n"])));
var Modal = function (_a) {
    var title = _a.title, onDismiss = _a.onDismiss, onBack = _a.onBack, children = _a.children, _b = _a.hideCloseButton, hideCloseButton = _b === void 0 ? false : _b, _c = _a.bodyPadding, bodyPadding = _c === void 0 ? "24px" : _c, props = __rest(_a, ["title", "onDismiss", "onBack", "children", "hideCloseButton", "bodyPadding"]);
    return (React.createElement(StyledModal, __assign({}, props),
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(StyledIconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$1d, { color: "primary" }))),
                React.createElement(Heading, null, title)),
            !hideCloseButton && (React.createElement(StyledIconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$_, { color: "primary" })))),
        React.createElement(Flex, { flexDirection: "column", p: bodyPadding }, children)));
};
var templateObject_1$e, templateObject_2$5, templateObject_3$3, templateObject_4$3;
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 165" }, props),
        React.createElement("image", { width: "205", href: isDark ? "/images/egg/LogoTextNewDark.png" : "/images/egg/LogoTextNewWhite.png" })));
};
...
var Logo = function (_a) {
    var showSideBar = _a.showSideBar, isDark = _a.isDark, href = _a.href, isMobile = _a.isMobile;
    ...
    return (React.createElement(Flex, { alignItems: "center", mt: isMobile ? "0" : "auto", mr: "45px" },
        !isMobile ? null : (React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: showSideBar },
            React.createElement(Icon$z, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "ShibaNova home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "ShibaNova home page" }, innerLogo))));
};
var templateObject_1$a;
...
var ButtonLabel = styled(Button)(templateObject_2$4 || (templateObject_2$4 = __makeTemplateObject(["\n  font-size: 15px;\n"], ["\n  font-size: 15px;\n"])));
var LinkLabel = styled.div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  color: inherit;\n  transition: color 0.4s;\n  flex-grow: 1;\n  font-weight: bold;\n  text-shadow: ", ";\n\n  &:hover {\n    opacity: 0.8;\n  }\n"], ["\n  color: inherit;\n  transition: color 0.4s;\n  flex-grow: 1;\n  font-weight: bold;\n  text-shadow: ", ";\n\n  &:hover {\n    opacity: 0.8;\n  }\n"])), function (_a) {
    var glowing = _a.glowing, theme = _a.theme;
    return (glowing ? theme.shadows.text : "none");
});
var MenuEntry = styled.div(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", ";\n  padding: ", ";\n  font-size: ", "px; \n  \n  background: ", ";\n  color: ", ";\n  line-height: ", ";\n  margin: ", ";\n  // box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  ", " {\n    padding: 0 20px;\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", ";\n  padding: ", ";\n  font-size: "
    ...
    return (secondary ? "0 24px" : "0 10px");
}, 
/* eslint-disable */
function (_a) {
    var isMobile = _a.isMobile, secondary = _a.secondary;
    return (isMobile ? (secondary ? 16 : 18) : 15);
}
/* eslint-enable */
, function (_a) {
    ...
    var secondary = _a.secondary, theme = _a.theme, isMobile = _a.isMobile;
    return secondary && !isMobile ? theme.colors.primary : "transparent";
}, function (_a) {
    var theme = _a.theme;
...
var templateObject_1$9, templateObject_2$4, templateObject_3$2, templateObject_4$2;
...
var NavBar = function (_a) {
    ...
    if (isMobile)
        return null;
    return (React.createElement(Flex, { style: { maxWidth: "50%" } },
        React.createElement(Container$1, null, links.map(function (entry) {
...
var Icon$1 = function (props) {
    return (React.createElement(Svg, __assign({ "data-name": "Layer 1", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 1000 1000" }, props),
        React.createElement("defs", null,
...
var StyledNav$1 = styled.nav(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  position: fixed;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  // background-color: ", ";\n  background: linear-gradient(\n    90deg,\n    rgba(6, 26, 84, 1) 0%,\n    rgba(6, 28, 124, 1) 40%,\n    rgba(6, 28, 124, 1) 60%,\n    rgba(4, 2, 66, 1) 100%\n  );\n  display: block;\n  z-index: 100;\n  margin: 0;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  padding: 30px 20px 30px;\n  transform: ", ";\n  transition: transform 0.2s linear 0s;\n\n  overflow-y: auto;\n  overscroll-behavior-y: none;\n  -webkit-overflow-scrolling: touch;\n"], ["\n  position: fixed;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  // background-color: ", ";\n  background: linear-gradient(\n    90deg,\n    rgba(6, 26, 84, 1) 0%,\n    rgba(6, 28, 124, 1) 40%,\n    rgba(6, 28, 124, 1) 60%,\n    rgba(4, 2, 66, 1) 100%\n  );\n  display: block;\n  z-index: 100;\n  margin: 0;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  padding: 30px 20px 30px;\n  transform: ", ";\n  transition: transform 0.2s linear 0s;\n\n  overflow-y: auto;\n  overscroll-behavior-y: none;\n  -webkit-overflow-scrolling: touch;\n"])), function (_a) {
    var theme = _a.theme;
...
var StyledCloseButton = styled.div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  position: absolute;\n  right: 20px;\n  top: 20px;\n  filter: drop-shadow(1px 1px 3px rgba(0, 170, 255, 0.584));\n"], ["\n  position: absolute;\n  right: 20px;\n  top: 20px;\n  filter: drop-shadow(1px 1px 3px rgba(0, 170, 255, 0.584));\n"])));
var StyledLinkList = styled.div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  margin-top: 2vw;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n"], ["\n  margin-top: 2vw;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n"])));
var StyledLinkSeparator = styled.hr(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  width: 200px;\n  border-color: ", ";\n"], ["\n  width: 200px;\n  border-color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.textSubtle;
});
var SideBar = function (_a) {
    ...
    return (React.createElement(StyledNav$1, { open: open },
        React.createElement(StyledCloseButton, null,
            React.createElement(Icon$_, { onClick: onDismiss })),
        React.createElement("div", { style: { marginLeft: -20 } }, price),
        React.createElement(StyledLinkList, null,
            React.createElement(Text, { glowing: true, bold: true, style: { padding: "3px 0 3px 0" } }, "ShibaNova"),
            links.slice(0, links.length - 2).map(function (entry) { return (React.createElement(MenuEntry, { onClick: onDismiss, isMobile: true, key: entry.href, isActive: entry.href === location.pathname },
                entry.icon && React.createElement(MenuIcon, { icon: entry.icon }),
                React.createElement(MenuLink, { onClick: onDismiss, style: { fontSize: 16, textTransform: "uppercase" }, href: entry.href },
                    React.createElement(LinkLabel, { onClick: onDismiss }, entry.label)))); }),
            React.createElement(StyledLinkSeparator, null),
            React.createElement(Text, { glowing: true, bold: true, style: { padding: "3px 0 3px 0" } }, "Earn"), (_b = vaults === null || vaults === void 0 ? void 0 : vaults.items) === null || _b === void 0 ? void 0 :
            _b.map(function (item) {
                return (React.createElement(MenuEntry, { onClick: onDismiss, isMobile: true, key: item.href, secondary: true, isActive: item.href === location.pathname },
                    item.icon && React.createElement(MenuIcon, { icon: item.icon }),
                    React.createElement(MenuLink, { onClick: onDismiss, style: { fontSize: 14, textTransform: "uppercase" }, href: item.href },
                        React.createElement(LinkLabel, { onClick: onDismiss }, item.label))));
            }),
            React.createElement(StyledLinkSeparator, null),
            React.createElement(Text, { glowing: true, bold: true, style: { padding: "3px 0 3px 0" } }, "Socials and More"), (_c = socials.items) === null || _c === void 0 ? void 0 :
...
var Menu = function (_a) {
    ...
    var renderPrice = function () {
        return novaPriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
            React.createElement(Icon$P, { width: "24px", mr: "5px" }),
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { isMobile: isMobile, showMenu: showMenu },
