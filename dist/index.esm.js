...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        isXl ? null : (React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: showSideBar, mr: "24px" },
...
var ButtonLabel = styled(Button)(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  font-size: 14px;\n  font-weight: 700;\n  padding: 0 10px;\n"], ["\n  font-size: 14px;\n  font-weight: 700;\n  padding: 0 10px;\n"])));
...
var NavBar = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(Container$3, null, links.map(function (entry) {
            ...
            if (entry.items) {
                return (React.createElement(Accordion, { key: entry.label, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, entry.items.map(function (item) {
            ...
            return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
                React.createElement(MenuLink, { href: entry.href }, entry.button ? (React.createElement(ButtonLabel, { size: "sm" }, entry.label)) : (React.createElement(LinkLabel, null, entry.label)))));
        }))));
};
var templateObject_1$B;
...
var SideBar = function (_a) {
    ...
    return (React.createElement(StyledNav, null,
        ...
        React.createElement(StyledLinkList, null, links.map(function (entry) { return (React.createElement(StyledLink$2, { onClick: onDismiss, exact: true, to: "/" }, entry.label)); })),
        React.createElement(StyledLinkSeparator, null),
        React.createElement(StyledLinkList, null, (_b = socials.items) === null || _b === void 0 ? void 0 : _b.map(function (entry) { return (React.createElement(StyledExternalLink, { onClick: onDismiss, href: entry.href, target: "_blank", rel: "noopener noreferrer" }, "Docs")); }))));
};
...
var Inner = styled.div(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n"], ["\n  flex-grow: 1;\n  margin-top: ", ";\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav$1, { showMenu: showMenu },
            React.createElement(Logo$1, { isXl: isXl, showSideBar: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            isPushed && React.createElement(SideBar, { onDismiss: function () { return setIsPushed(false); }, links: links }),
            React.createElement(NavBar, { isXl: isXl, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, links: links, priceLink: priceLink }),
