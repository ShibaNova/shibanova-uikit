...
var ButtonMenuItem = function (_a) {
    ...
    return React.createElement(StyledButton$1, __assign({ as: as, size: size, variant: variant }, props));
};
...
var StyledIconButton = styled(IconButton)(templateObject_1$w || (templateObject_1$w = __makeTemplateObject(["\n  &:hover {\n    background: transparent !important;\n  }\n"], ["\n  &:hover {\n    background: transparent !important;\n  }\n"])));
var StyledModal = styled.div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  background: ", ";\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  border: 1px solid ", ";\n  border-radius: 32px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"], ["\n  background: ", ";\n  box-shadow: 0px 20px 36px -8px rgba(14, 14, 44, 0.1), 0px 1px 1px rgba(0, 0, 0, 0.05);\n  border: 1px solid ", ";\n  border-radius: 32px;\n  width: 100%;\n  z-index: ", ";\n  overflow-y: auto;\n  ", " {\n    width: auto;\n    min-width: 360px;\n    max-width: 100%;\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, { alignItems: "center", mt: isMobile ? "0" : "auto", mr: "45px" },
        !isMobile ? null : (React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: showSideBar },
            React.createElement(Icon$L, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "ShibaNova home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "ShibaNova home page" }, innerLogo))));
};
var templateObject_1$A;
...
var ButtonLabel = styled(Button)(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  font-size: 15px;\n"], ["\n  font-size: 15px;\n"])));
var LinkLabel = styled.div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  color: inherit;\n  transition: color 0.4s;\n  flex-grow: 1;\n  font-weight: bold;\n  text-shadow: ", ";\n\n  &:hover {\n    opacity: 0.8;\n  }\n"], ["\n  color: inherit;\n  transition: color 0.4s;\n  flex-grow: 1;\n  font-weight: bold;\n  text-shadow: ", ";\n\n  &:hover {\n    opacity: 0.8;\n  }\n"])), function (_a) {
    var glowing = _a.glowing, theme = _a.theme;
    return (glowing ? theme.shadows.text : "none");
});
var MenuEntry = styled.div(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", ";\n  padding: ", ";\n  font-size: ", "px;\n  background-color: ", ";\n  color: ", ";\n  line-height: ", ";\n  margin: ", ";\n  // box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  ", " {\n    padding: 0 20px;\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", ";\n  padding: ", ";\n  font-size: "
    /* eslint-disable */
    ,
    /* eslint-enable */
    "px;\n  background-color: ", ";\n  color: ", ";\n  line-height: ", ";\n  margin: ", ";\n  // box-shadow: ", ";\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n  }\n\n  svg {\n    fill: ", ";\n  }\n\n  &:hover {\n    background-color: ",
...
var StyledNav = styled.nav(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  position: fixed;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  // background-color: ", ";\n  background: linear-gradient(\n    90deg,\n    rgba(6, 26, 84, 1) 0%,\n    rgba(6, 28, 124, 1) 40%,\n    rgba(6, 28, 124, 1) 60%,\n    rgba(4, 2, 66, 1) 100%\n  );\n  display: block;\n  z-index: 100;\n  margin: 0;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  padding: 30px 20px 30px;\n  transform: ", ";\n  transition: transform 0.2s linear 0s;\n\n  overflow-y: auto;\n  overscroll-behavior-y: none;\n  -webkit-overflow-scrolling: touch;\n"], ["\n  position: fixed;\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  // background-color: ", ";\n  background: linear-gradient(\n    90deg,\n    rgba(6, 26, 84, 1) 0%,\n    rgba(6, 28, 124, 1) 40%,\n    rgba(6, 28, 124, 1) 60%,\n    rgba(4, 2, 66, 1) 100%\n  );\n  display: block;\n  z-index: 100;\n  margin: 0;\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  padding: 30px 20px 30px;\n  transform: ", ";\n  transition: transform 0.2s linear 0s;\n\n  overflow-y: auto;\n  overscroll-behavior-y: none;\n  -webkit-overflow-scrolling: touch;\n"])), function (_a) {
    var theme = _a.theme;
...
var SideBar = function (_a) {
    ...
    return (React.createElement(StyledNav, { open: open },
        ...
        React.createElement(StyledLinkList, null,
            React.createElement(Heading, { glowing: true }, "ShibaNova"),
            links.slice(0, links.length - 2).map(function (entry) { return (React.createElement(MenuEntry, { onClick: onDismiss, isMobile: true, key: entry.href, isActive: entry.href === location.pathname },
                ...
                React.createElement(MenuLink, { href: entry.href },
                    React.createElement(LinkLabel, null, entry.label.toUpperCase())))); }),
            React.createElement(StyledLinkSeparator, null),
            React.createElement(Heading, { glowing: true }, "Vault Partners"), (_b = vaults === null || vaults === void 0 ? void 0 : vaults.items) === null || _b === void 0 ? void 0 :
            _b.map(function (item) {
                return (React.createElement(MenuEntry, { isMobile: true, key: item.href, secondary: true, isActive: item.href === location.pathname },
                    ...
                    React.createElement(MenuLink, { href: item.href },
                        React.createElement(LinkLabel, null, item.label.toUpperCase()))));
            }),
            React.createElement(StyledLinkSeparator, null),
            React.createElement(Heading, { glowing: true }, "Socials and More"), (_c = socials.items) === null || _c === void 0 ? void 0 :
...
var templateObject_1$H, templateObject_2$g, templateObject_3$8, templateObject_4$5, templateObject_5$1;
