...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "tertiary", colorKey: variant === variants$1.PRIMARY ? "text" : "text" }, props)));
    }
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, { alignItems: "center", mt: isMobile ? "0" : "auto", mr: "45px" },
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "NovaDex home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "NovaDex home page" }, innerLogo))));
};
var templateObject_1$b;
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        React.createElement(HelpLink, { href: "https://docs.novadex.finance/shibanova-documentation/how-to-connect-a-wallet", external: true },
...
var UserBlock = function (_a) {
    ...
    return (React.createElement(Container, null,
        React.createElement("a", { href: "https://github.com/ShibaNova/Contracts/tree/main/Audits", target: "_blank", rel: "noreferrer noopener" },
            React.createElement(Icon$9, { style: { paddingRight: "5px", width: "40px", marginLeft: 10 } })),
...
var Menu = function (_a) {
    ...
    var renderPrice = function () {
        return novaPriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
            ...
            React.createElement(Text, { fontSize: "55px", small: true, bold: true, marginRight: "50px" }, "$" + novaPriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
    };
